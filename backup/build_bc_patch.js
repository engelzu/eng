...
for (const input of inputs) {
  ...
  if (input.id === 'bcGerenciaEstudos' || input.id === 'bcGerenciaEngenharia') {
    modalMarkup += "(0,t.jsxs)(\"div\",{className:\"flex flex-col gap-1\",children:[(0,t.jsx)(\"label\",{className:\"text-[10px] font-black tracking-wider text-slate-500 uppercase\",children:\"" + input.label + "\"})]})";
  } else {
