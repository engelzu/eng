...
fs.copyFileSync('_next/static/chunks/507-1cbb4e1ae80f89d3.js.bak', '_next/static/chunks/507-1cbb4e1ae80f89d3.js');
fs.copyFileSync('_next/static/chunks/507-1cbb4e1ae80f89d3.js.bak', 'OUT/_next/static/chunks/507-1cbb4e1ae80f89d3.js');
...
let inputsMarkup = inputs.map(input => {
  if (input.id === 'bcGerenciaEstudos' || input.id === 'bcGerenciaEngenharia') {
    return `(0,t.jsxs)("div",{className:"flex flex-col gap-1",children:[(0,t.jsx)("label",{className:"text-[10px] font-black tracking-wider text-slate-500 uppercase",children:"${input.label}"})]})`;
  }
...
let modalMarkup = `(0,t.jsx)(l.Vq,{open:showBcModal,onOpenChange:setShowBcModal,children:(0,t.jsxs)(l.cZ,{className:"w-[98vw] max-w-[1200px] max-h-[95vh] flex flex-col overflow-hidden border-indigo-500 shadow-2xl rounded-2xl",children:[(0,t.jsxs)(l.fK,{className:"p-4 pb-3 bg-indigo-50/50 border-b border-indigo-100 shrink-0",children:[(0,t.jsxs)(l.$N,{className:"flex items-center gap-2 text-indigo-800 text-lg font-black",children:[(0,t.jsx)(S.Z,{className:"h-6 w-6"}),"BUSINESS CASE DIGITAL " + ((a&&a.code) ? " - Código #" + a.code : "")]}),(0,t.jsx)(l.Be,{className:"text-sm text-indigo-600/80",children:"Preencha os dados abaixo para compor o documento de Business Case."})]}),(0,t.jsxs)("div",{className:"p-4 space-y-4 flex-1 overflow-y-auto bg-slate-50/30",children:[(0,t.jsx)("div",{className:"grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-5 xl:grid-cols-5 gap-2 p-2.5 bg-white border border-slate-200 rounded-xl shadow-sm",children:[${inputsMarkup}]}),(0,t.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-1 gap-3",children:[${textareasMarkup}]})]}),(0,t.jsxs)(l.cN,{className:"shrink-0 p-3 bg-slate-50 border-t border-slate-100 flex justify-between items-center gap-2",children:[${switchToggle},(0,t.jsxs)("div",{className:"flex gap-2",children:[(0,t.jsx)("button",{type:"button",onClick:()=>setShowBcModal(!1),className:"rounded-xl font-black text-xs px-4 py-2 border border-slate-300 text-slate-700 hover:bg-slate-100 bg-white",children:"FECHAR"}),(0,t.jsx)("button",{type:"button",onClick:()=>{bcDataRef.current={${saveVars}};setShowBcModal(!1);},className:"bg-emerald-600 hover:bg-emerald-700 text-white border border-emerald-700 rounded-xl font-black text-xs px-4 py-2 shadow-sm",children:"SALVAR BUSINESS CASE"})]})]})]})})`;

for (const f of files) {
  if (!fs.existsSync(f)) continue;
  let code = fs.readFileSync(f, 'utf8');

  // 1. Inject ModalLibrary_507 alias (Disabled as we use local 'l' directly)
  // const aliasTarget = ...
  ...
  const newExitBtn = 'X&&(0,t.jsxs)("div",{className:"flex gap-2 items-center",children:[(0,t.jsxs)("button",{type:"button",onClick:()=>setShowBcModal(!0),className:"h-12 px-6 bg-emerald-600 hover:bg-emerald-700 text-white font-black flex items-center gap-1.5 border border-emerald-700 shadow-sm uppercase rounded-full transition-all hover:shadow-md active:scale-95",children:[(0,t.jsx)(S.Z,{className:"h-5 w-5 text-white"}),"FAZER O BUSINESS CASE DIGITAL"]}),(0,t.jsxs)(o.z,{type:"button",variant:"destructive",size:"lg",onClick:X,className:"h-12 px-8 font-bold shadow-sm hover:shadow-md transition-all",children:[(0,t.jsx)(R.Z,{className:"w-5 h-5 mr-2"}),"SAIR SEM SALVAR"]})]})';
  ...
  if (code.includes(modalTarget) && !code.includes('SALVAR BUSINESS CASE')) {
    code = code.replace(modalTarget, modalTarget + modalMarkup + ',');
  ...
  if (code.includes(selectDropdownTarget) && !code.includes('value:"REVISÃO FINAL"')) {
    code = code.replace(selectDropdownTarget, '(0,t.jsx)(j.Ql,{value:"REVISÃO FINAL",children:"REVISÃO FINAL"}),(0,t.jsx)(j.Ql,{value:"PRIORIZADOS",children:"PRIORIZADOS"})');
    console.log('Injected dropdown option REVISÃO FINAL');
  }
