const fs = require('fs');
let code = fs.readFileSync('c:/Users/user2/Downloads/Eng22_06/patch_bc.js', 'utf8');
...
if (!code.includes('page-5d0c28c966a6b026.js')) {
  code = code.replace(/const files = \[[^\]]*\];/, `const files = [
