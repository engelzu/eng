...
files.forEach(f => {
  ...
  const codeBlockReplacement = codeBlockTarget + ',(0,t.jsxs)("div",{className:"flex flex-col gap-0.5",children:[(0,t.jsx)(g._,{className:"text-[9px] text-muted-foreground uppercase font-black tracking-tighter",children:"MODELO CONT\\xc1BIL"}),(0,t.jsxs)("div",{className:"flex items-center gap-1.5 mt-0.5",children:[(0,t.jsxs)("select",{value:modeloContabil,onChange:e=>{let val=e.target.value;setModeloContabil(val);if(val==="CAPEX"){setShowCapexModal(!0)}else{setTipoCapex("")}},className:"h-8 border border-slate-200 rounded-lg px-2 text-[11px] bg-white focus:border-emerald-500 outline-none font-bold text-slate-800 shadow-sm transition-all w-[100px]",children:[(0,t.jsx)("option",{value:"",children:"Selecione..."}),(0,t.jsx)("option",{value:"CAPEX",children:"CAPEX"}),(0,t.jsx)("option",{value:"C.CUSTO",children:"C.CUSTO"})]}),modeloContabil==="CAPEX"&&tipoCapex&&(0,t.jsx)("span",{className:"text-[9px] font-black text-emerald-600 bg-emerald-50 border border-emerald-200 px-2 py-1.5 rounded cursor-pointer hover:bg-emerald-100/80 transition-all text-center uppercase tracking-wider whitespace-nowrap",onClick:()=>setShowCapexModal(!0),children:tipoCapex})]})]})';
